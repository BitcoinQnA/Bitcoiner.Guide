...
| [Start9](#start9-server)                    | $499 (8GB Pi)                     |
|                                             | $1799 Pro (x86_64 Intel w/o IME)  |
...
A [Start9 Personal Server](https://store.start9.com/collections/servers) is a small server with 8, 16, or 32 GB of RAM, and 1, 2 or 4 TB SSD, with a focus on making setup and interaction as frictionless as possible. By running one of these as your own personal server, you can do more than just be a Bitcoin node.
...
Comes pre built with a Raspberry Pi 8GB RAM, Intel N4505 w/ 16GB RAM, or Intel i7-10510U 32GB RAM.

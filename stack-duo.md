...
<p align="center">
  ...
  <a href="#importing-your-coldcard">Feature Showcase</a> |
  <br><br>
</p>
...
`Home` > `Add Wallet` > `Bitcoin` > `New Wallet`.

<p align="center">
  <img src="/assets/img/stack-duo-initial-setup-15.png" class="responsive" style="max-width: 100%; height: auto;" />
</p>
...
Back to your home page, select the wallet you wish to receive sats to. Click `receive` on the bottom left corner.
...
Stack Wallet Backup is a convenience feature that makes it simple and easy to restore all of your wallets at once. 
...
- Process of toggling on Coin Control 
...
However, address books can encourage users to reuse the same Bitcoin addresses for multiple transactions, which can compromise privacy. It is **highly** recommended to use a new address for each transaction to make it harder for third parties to link transactions to a specific user. For this reason, consider using privacy-focused wallet features such as PayNyms when creating a new contact.
